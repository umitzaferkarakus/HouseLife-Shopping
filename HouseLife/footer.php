			...
			<div class="row">
				...
				<div class="col-md-4"><!--footer contact widget-->
					...
					<ul class="contact-widget">
						<li class="fphone"> <?php echo $checksetting['setting_gsm'] ?> <br> <?php echo $checksetting['setting_phone'] ?></li>
						
						<li class="fmail lastone"> <?php echo $checksetting['setting_mail'] ?> </li>
					</ul>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="f-credit"><?php echo $checksetting['setting_author'] ?></a></div>
				...
				<div class="col-md-3"><!--footer Share-->
					...
					<div class="fsoc">
						<a href="<?php echo $checksetting['setting_twitter'] ?>" class="ftwitter">twitter</a>
						<a href="<?php echo $checksetting['setting_facebook'] ?>" class="ffacebook">facebook</a>
						<a href="<?php echo $checksetting['setting_youtube'] ?>" class="fflickr">flickr</a>
						<a href="<?php echo $checksetting['setting_google'] ?>" class="ffeed">feed</a>
						<div class="clearfix"></div>
					</div>
					<div class="clearfix"></div>
				</div><!--footer Share-->
